...
type Querier interface {
	...
	ListEmployeeCompensationPackagesByOrg(ctx context.Context, orgID string) ([]EmployeeCompensationPackage, error)
	ListEmployeeCompensationPackagesByOrgIncludingDeleted(ctx context.Context, orgID string) ([]EmployeeCompensationPackage, error)
