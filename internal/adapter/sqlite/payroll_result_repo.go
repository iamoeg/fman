...
func rowToPayrollResult(row sqldb.PayrollResult) (*domain.PayrollResult, error) {
	...
	return &domain.PayrollResult{
		...
		SeniorityYears:                     int(row.SeniorityYears),
		SeniorityRate:                      row.SeniorityRate,
		...
		FamilyAllowance:                    money.FromCents(row.FamilyAllowanceCents),
...
func payrollResultToCreateParams(res *domain.PayrollResult) sqldb.CreatePayrollResultParams {
	return sqldb.CreatePayrollResultParams{
		...
		SeniorityYears:                          int64(res.SeniorityYears),
		SeniorityRate:                           res.SeniorityRate,
		...
		FamilyAllowanceCents:                    res.FamilyAllowance.Cents(),
